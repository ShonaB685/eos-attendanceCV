/* Vanilla-JS port of the KineticGrid React component: a canvas grid that
   warps toward the cursor and ripples on click. Same math/constants as the
   original, translated from hooks/JSX to a plain init-on-load script since
   this project has no React/build step. */
(function () {
  "use strict";
  ...
  const THEMES = {
    ...
    monochrome: {
      bg: "#141416",
      lineActive: { r: 255, g: 255, b: 255, a: 0.55 },
      nodeActive: { r: 255, g: 255, b: 255, a: 0.85 },
      glow: "255,255,255",
      ripple: "255,255,255",
    },
  };
  ...
  function initKineticGrid(canvas, globalColor) {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    if (canvas) {
      initKineticGrid(canvas, canvas.dataset.theme || "default");
    }
  });
})();
